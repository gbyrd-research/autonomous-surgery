...
class Lift3dCLIP(nn.Module):
    ...
    def forward(self, pts):
        ...
        # -------------------------------------------
        # GET FEATURE EMBEDDINGS (TOKENS) FOR THE POINTCLOUD
        ...
        # -------------------------------------------
        # GET 2D POSITION EMBEDDINGS FOR EACH 3D POINT

        # center corresponds to the 3d location of each token
        # group input tokens corresponds to the generated embeddings from the pcd
        # center shape: [B, N, 3] - group_input_tokens shape: [B, N, embedding_dim]
        ...
        # this returns just the CLS token, which should contained a learned 

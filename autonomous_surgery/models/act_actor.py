# autonomous_surgery/models/act/act_actor.py
# -*- coding: utf-8 -*-
"""
autonomous_surgery + ACT (DETR-VAE style) actor (with conditional prior).
...
class autonomous_surgeryActActor(nn.Module):
    ...
    def forward(
        ...
        tokens_d, global_d = self._autonomous_surgery_encode_tokens(images, point_clouds, robot_states, texts)
        bs = tokens_d.shape[0]

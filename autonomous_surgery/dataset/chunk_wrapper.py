# autonomous_surgery/dataset/chunk_wrapper.py
# -*- coding: utf-8 -*-
...
class ChunkDatasetWrapper(Dataset):
    """
    Wrap a *step-based* autonomous_surgery dataset (single-step BC) into a *chunk-supervised* dataset.
    ...
    def __init__(
        ...
        #   base_dataset:
        #     _target_: autonomous_surgery.dataset.MetaWorldDataset
        #     ...
        ...
        if isinstance(base_dataset, Dataset):
            ...
            # Pass data_dir/split through if provided (these match MetaWorldDataset signature in autonomous_surgery)

...
"""
autonomous_surgery/tools/act_policy.py

ACT-style training script (chunk supervision + optional VAE KL loss),
compatible with autonomous_surgery Hydra config layout.
...
IMPORTANT:
  ...
  - KL (and pad loss) should be handled inside the configured loss_func (e.g., autonomous_surgery/loss/act_vae_loss.py).
"""

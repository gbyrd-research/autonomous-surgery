...
python -m lift3d.tools.act_policy_normal \
  ...
  train.num_epochs=10000 train.learning_rate=1e-6 train.kl_weight=10 \
  dataset_dir=/projects/surgical-video-digital-twin/datasets/act_peg_recover/1216/zarr \
  hydra.run.dir=/projects/surgical-video-digital-twin/new_results/act_peg_recover/3dact_normal120_lr1e-6_kl10 \
